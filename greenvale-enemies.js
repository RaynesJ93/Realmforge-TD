...
(function(){
 ...
 function draw(e,c){
   ...
   if(cfg.svg)c.drawImage(img,-size/2,-size*124/128,size,size);else c.drawImage(img,frame*128,0,128,128,-size/2,-size*124/128,size,size);c.restore();
